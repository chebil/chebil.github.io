...
1. Chapter 1: [Introduction to Logic Problem Solvers](chap1.md)
2. Chapter 2: [Datasets for Logic Problem Solvers](chap2.md)
3. Chapter 3: [ Queries and Updates for Logic Problem Solvers](chap3.md)
4. Chapter 4: [Query Evaluation and Optimization](chap4.md)
5. Chapter 5: [View Definitions and Evaluation](chap5.md)
6. Chapter 6: Operation definitions
6. Chapter 7: Other Types of Logic Programming for Problem Solvers
