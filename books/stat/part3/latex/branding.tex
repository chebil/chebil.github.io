...
%  Shared re-branding for the Stats course (input AFTER theme.tex)
%  Overrides the CS3401 footer/title page from theme.tex.
% ============================================================

% Footer rebranded for the Statistics course
  ...
  \hbox{%
    \begin{beamercolorbox}[wd=0.60\paperwidth,ht=1.8em,dp=0.6em,leftskip=1em]{normal text}%
      \textcolor{PrimaryDark}{\tiny\textbf{Dr. Khalil Chebil} %
        \quad\textbar\quad Probability \& Statistics for CS}%
    \end{beamercolorbox}%
...
% Title page rebranded for the Statistics course
\setbeamertemplate{title page}{%
  ...
  \vspace{0.6cm}
  \begin{center}
    {\tiny\textcolor{PrimaryLight}{\textbf{Probability and Statistics}
      \textendash{} for Computer Science}}\\[0.2em]
    {\tiny\textcolor{PrimaryLight}{Based on Forsyth, \emph{Probability and
      Statistics for Computer Science} (2018)}}\\[1.2em]
    {\footnotesize\textcolor{AccentYellow}{\textbf{Applied Statistics and
      Probability for Computer Scientists}}}\\[1.5em]
